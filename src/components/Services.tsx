...
const Services: React.FC = () => {
  ...
  return <section id="leistungen" className="py-24 bg-figuro-cream">
      <div className="container-custom">
        ...
        <div className="mb-16">
          <h2 className="text-4xl md:text-5xl font-bold text-figuro-dark-green max-w-xl">Unsere Leistungen auf einen Blick</h2>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {services.map((service, index) => <div key={index} className="bg-figuro-dark-green/5 border border-figuro-dark-green/10 p-8 rounded-xl hover:bg-white transition-all duration-300">
              <div className="mb-6">
                {service.icon}
              </div>
